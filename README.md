...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,539 | 🐛 106 | 📅 2026-09-02
...
* [Computer Science courses with video lectures](https://github.com/Developer-Y/cs-video-courses/blob/master/README.md) ⭐ 83,434 | 🐛 6 | 📅 2026-08-30 | Developer-Y
* [List of Computer Science courses](https://github.com/Developer-Y/cs-video-courses) ⭐ 83,434 | 🐛 6 | 📅 2026-08-30 | List of Computer Science courses with video lectures
* [Awesome Computer Vision](https://github.com/jbhuang0604/awesome-computer-vision) ⭐ 23,539 | 🐛 92 | 📅 2024-05-17 | Jia-Bin Huang
* [OpenCV: C++ and Python](https://github.com/spmallick/learnopencv) ⭐ 23,127 | 🐛 220 | 🌐 Jupyter Notebook | 📅 2026-08-30 | Satya Mallick
* [Machine Learning Engineering](https://github.com/stas00/ml-engineering) ⭐ 18,918 | 🐛 4 | 🌐 Python | 📅 2026-09-04 | Machine Learning Engineering Open Book
* [Modern C++ Programming](https://github.com/federico-busato/Modern-CPP-Programming) ⭐ 16,090 | 🐛 5 | 🌐 HTML | 📅 2026-04-19 | Modern C++ Programming Course (C++11/14/17/20)
...
* [Roboflow Notebooks](https://github.com/roboflow/notebooks) ⭐ 9,643 | 🐛 89 | 🌐 Jupyter Notebook | 📅 2026-08-14 | Jupyter Notebooks with Computer Vision tutorials
...
* [Awesome Robotics](https://github.com/kiloreux/awesome-robotics/blob/master/README.md) ⭐ 7,017 | 🐛 40 | 📅 2024-09-22 | Huge awesome list for robotics by kiloreux
* [Machine Learning Course Notes](https://github.com/dair-ai/ML-Course-Notes) ⭐ 6,658 | 🐛 5 | 📅 2024-05-16 | DAIR.AI
...
* [Start Machine Learning](https://github.com/louisfb01/start-machine-learning) ⭐ 5,296 | 🐛 5 | 📅 2026-01-23 | A complete guide to start and improve in ML, AI by Louis-François Bouchard
...
* [Mathematics for Robotics](https://github.com/michiganrobotics/rob501) ⭐ 2,964 | 🐛 1 | 📅 2022-03-21 | University of Michigan
...
* [Coding Notes and Tutorials](https://github.com/methylDragon/coding-notes) ⭐ 606 | 🐛 4 | 🌐 C++ | 📅 2023-11-23 | A compilation of tutorials and references for different coding languages and frameworks
* [Coding Notes](https://github.com/methylDragon/coding-notes) ⭐ 606 | 🐛 4 | 🌐 C++ | 📅 2023-11-23 | Coding notes in many programming languages by methylDragon
...
* [ROS Autonomous Driving and Path Planning SLAM with TurtleBot3](https://github.com/noshluk2/ROS-Autonomous-Driving-and-Path-Planning-SLAM-with-TurtleBot) ⭐ 160 | 🐛 4 | 🌐 Python | 📅 2023-05-26 | Muhammad Luqman
...
* [Introduction to Autonomous Robots](https://github.com/correll/Introduction-to-Autonomous-Robots/releases) ⭐ 3,506 | 🐛 8 | 🌐 TeX | 📅 2026-02-11 **| Nikolaus Correll, Magellan Scientific**
* [SLAM Book](https://github.com/gaoxiang12/slambook-en) ⭐ 1,911 | 🐛 30 | 🌐 TeX | 📅 2025-07-07 **| Xiang Gao**
* [A Concise Introduction to Robot Programming with ROS2](https://github.com/fmrico/book_ros2) ⭐ 824 | 🐛 6 | 🌐 C++ | 📅 2026-03-26 **| Francisco Martín Rico**
* [Robotics, Vision & Control: 3rd edition in Python](https://github.com/petercorke/RVC3-python) ⭐ 771 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-08-26 **| Peter Corke, published by Springer-Nature 2023**
...
* [Awesome ChatGPT Prompts](https://github.com/f/awesome-chatgpt-prompts) ⭐ 169,472 | 🐛 74 | 🌐 HTML | 📅 2026-09-06 | ChatGPT prompt curation to use ChatGPT better
* [openpilot](https://github.com/commaai/openpilot) ⭐ 63,583 | 🐛 141 | 🌐 Python | 📅 2026-09-06 | Open source driver assistance system
* [Face Recognition](https://github.com/ageitgey/face_recognition) ⭐ 56,706 | 🐛 832 | 🌐 Python | 📅 2026-06-25 | The world's simplest facial recognition API for Python and the command line
* [Segment Anything](https://github.com/facebookresearch/segment-anything) ⭐ 54,809 | 🐛 594 | 🌐 Jupyter Notebook | 📅 2024-09-18 | A new task, model, and dataset for image segmentation
* [PythonRobotics](https://github.com/AtsushiSakai/PythonRobotics) ⭐ 30,456 | 🐛 54 | 🌐 Python | 📅 2026-09-02 | Python code collection of robotics algorithms, especially for autonomous navigation
...
* [AirSim](https://github.com/Microsoft/AirSim) ⭐ 18,455 | 🐛 780 | 🌐 C++ | 📅 2026-06-30 | A simulator for drones (and soon other vehicles) built on Unreal Engine
...
* [FTXUI](https://github.com/ArthurSonzogni/FTXUI) ⭐ 10,649 | 🐛 97 | 🌐 C++ | 📅 2026-09-02 | C++ Functional Terminal User Interface
* [ORB-SLAM2](https://github.com/raulmur/ORB_SLAM2) ⭐ 10,234 | 🐛 806 | 🌐 C++ | 📅 2024-05-15 | University of Zaragoza - Raúl Mur Artal
...
* [GTSAM](https://github.com/borglab/gtsam) ⭐ 3,670 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2026-09-06 | A C++ library that implements smoothing and mapping (SAM) in robotics and vision
* [Robotics Toolbox for Python](https://github.com/petercorke/robotics-toolbox-python) ⭐ 3,476 | 🐛 50 | 🌐 C++ | 📅 2026-09-01 | Robotics Toolbox for Python
...
* [OpenVINS](https://github.com/rpng/open_vins) ⭐ 3,084 | 🐛 74 | 🌐 C++ | 📅 2025-11-30 | Computer vision code along with a state-of-the art filter-based visual-inertial estimator
...
* [Awesome Robotics Libraries](https://github.com/jslee02/awesome-robotics-libraries) ⭐ 3,037 | 🐛 21 | 🌐 Python | 📅 2026-09-06 | A curated list of robotics simulators and libraries
...
* [EGO-Planner](https://github.com/ZJU-FAST-Lab/ego-planner) ⭐ 2,640 | 🐛 40 | 🌐 C++ | 📅 2025-03-08 | This is a lightweight but robust quadrotor local planning framework
* [SLAM Toolbox](https://github.com/SteveMacenski/slam_toolbox) ⭐ 2,617 | 🐛 48 | 🌐 C++ | 📅 2026-08-19 | A set of tools and capabilities for 2D SLAM
* [robosuite](https://github.com/ARISE-Initiative/robosuite) ⭐ 2,596 | 🐛 113 | 🌐 Python | 📅 2026-07-11 |  A simulation framework powered by the MuJoCo physics engine for robot learning
...
* [Webviz](https://github.com/cruise-automation/webviz) ⭐ 2,339 | 🐛 134 | 🌐 JavaScript | 📅 2022-12-17 | Web-based application for playback and visualization of ROS bag files
...
* [POLYSCOPE](https://github.com/nmwsharp/polyscope) ⭐ 2,201 | 🐛 127 | 🌐 C++ | 📅 2026-09-06 | A C++/Python viewer and user interface for 3D data such as meshes and point clouds
* [MRPT Project](https://github.com/MRPT/mrpt) ⭐ 2,160 | 🐛 28 | 🌐 C++ | 📅 2026-09-05 | Mobile Robot Programming Toolkit provides C++ libraries aimed at researchers in mobile robotics and computer vision
...
* [Small GICP](https://github.com/koide3/small_gicp/tree/master) ⭐ 1,027 | 🐛 27 | 🌐 C++ | 📅 2026-08-31 | A header-only C++ library that offers efficient and parallelized algorithms for fine point cloud registration (ICP, Point-to-Plane ICP, GICP, VGICP, etc.)
...
* [SPENCER](https://github.com/spencer-project/spencer_people_tracking) ⭐ 715 | 🐛 34 | 🌐 C++ | 📅 2021-02-02 | Multi-modal ROS-based people detection and tracking framework for mobile robots
...
* [Dynablox](https://github.com/ethz-asl/dynablox) ⭐ 602 | 🐛 4 | 🌐 C++ | 📅 2025-03-09 | An online volumetric mapping-based approach for real-time detection of diverse dynamic objects in complex environments
...
* [FusionCore](https://github.com/manankharwar/fusioncore) ⭐ 343 | 🐛 34 | 🌐 C++ | 📅 2026-09-06 | A ROS 2 UKF fusing GPS, IMU, and wheel odometry with adaptive noise and GPS outlier rejection for robust outdoor localization
